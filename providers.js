...
const HISTORY_POOL = {
  ...
  lazy: [
    'How to boil water, step by step', 'Is today actually Tuesday or not', 'Reply ok but make it sound professional',
    'How do I even open a PDF', 'Write a quick text to my mom', 'What is 7 plus 5, no calculator',
    'Read my own resume back to me', 'How to microwave ice cream properly', 'How to turn my laptop fully off',
    'What time is it, I have a phone', 'Unmute me on Zoom, it\'s urgent', 'Take a screenshot of this for me',
    'How do I unzip a file already', 'Restart my router again, one more time', 'Set a timer without touching my phone',
    'Reply to k without starting a war', 'Write my whole grocery list from memory', 'Summarize this two-line email for me',
    'Explain the group chat, I stopped reading', 'Do my math homework, just this once', 'Write happy birthday but make it longer',
    'Read the terms and conditions for me', 'Tell me what\'s probably in my fridge',
  ],
  dark: [
  ...
  tech: [
    'Why is my code just not working', 'Center a div, this is attempt forty-seven', 'How do I undo a forced git push',
    'My laptop hates me personally, I can tell', 'Explain "works on my machine" to my boss', 'Why did adding a console.log fix it',
    'Is turning it off and on a fix', 'How to explain merge conflicts to my grandma', 'My code works and I don\'t know why',
    'Explain the cloud like it\'s not a computer', 'Why did deleting node_modules fix everything', 'Explain recursion, like actually this time',
    'Why does my Wi-Fi only die during meetings', 'How many tabs is too many, be honest', 'Why did that random change even work',
  ],
  life: [
    'A polite email to my landlord, not really', 'Best excuse for being late, yet again', 'How to adult, absolute beginner level',
    'How do I actually fold a fitted sheet', 'Best way to fake a call and escape', 'How to say no for the fifth time',
    'How to un-invite myself from a plan', 'How to survive small talk without disappearing', 'Is napping this much actually a problem',
    'How to leave a party without saying bye', 'How to seem busy while ignoring a meeting', 'How to answer "what do you do"',
    'Can dogs safely eat pizza crust', 'Is 3pm too early to put on pajamas', 'How do adults even make new friends',
  ],
  existential: [
  ...
  petty: [
    'How to win an argument I already lost', 'Draft a text that I will never send', 'How to subtly one-up my sibling, again',
    'Best comeback for something said in 2019', 'How to seem unbothered when very bothered', 'Write a passive-aggressive note for the office fridge',
    'How to win a group chat debate, retroactively', 'Write a review that\'s technically not lying',
  ],
  money: [
    'How to explain my own bank statement', 'Budget advice where the answer isn\'t stop spending', 'Explain crypto like I only have twelve dollars',
    'How to negotiate a raise without passing out', 'How to split a bill without doing math', 'What even is a Roth IRA, genuinely',
    'Is buying coffee every day really the problem',
  ],
};
